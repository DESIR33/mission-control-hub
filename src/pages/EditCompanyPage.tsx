    ...
    <div className="min-h-screen bg-background">
      <div className="border-b border-border bg-card">
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          <h1 className="text-4xl font-bold text-foreground">Edit Company</h1>
      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-3xl">
        <div className="rounded-lg border border-border bg-card p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <h3 className="text-sm font-semibold text-muted-foreground pt-2">Social Links</h3>
            ...
            <div className="space-y-1.5">
              ...
              <Textarea id="edit_notes" name="notes" rows={3} defaultValue={company.notes ?? ""} className="bg-secondary border-border" />
            </div>
