...
import { NewsletterIssuesList } from "@/components/subscribers/NewsletterIssuesList";
import { ReferralLeaderboard } from "@/components/subscribers/ReferralLeaderboard";
    ...
    <div className="p-4 sm:p-6 lg:p-8 min-h-screen">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList className="flex-wrap h-auto gap-1">
          ...
          <TabsTrigger value="retention">Retention & Topics</TabsTrigger>
