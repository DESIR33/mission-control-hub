...
import { chartTooltipStyle, cartesianGridDefaults, xAxisDefaults, yAxisDefaults, fmtCount } from "@/lib/chart-theme";
        ...
        <div className="rounded-xl border border-border bg-card p-4">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={chartData}>
              ...
              <Bar dataKey="suggested" fill="#3b82f6" name="Suggested" radius={[6, 6, 0, 0]} maxBarSize={48} animationDuration={800} />
              <Bar dataKey="historical" fill="#22c55e" name="Your Avg" radius={[6, 6, 0, 0]} maxBarSize={48} animationDuration={800} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      )}
