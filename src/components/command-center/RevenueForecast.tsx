      ...
      <div className="rounded-lg border border-border bg-card p-4">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <AreaChart data={forecast.forecastPoints}>
            ...
            <Legend />
            <Area type="monotone" dataKey="actual" stroke="#22c55e" fill="url(#gradRevActual)" name="Actual" />
            <Area type="monotone" dataKey="forecast" stroke="#3b82f6" fill="url(#gradRevForecast)" strokeDasharray="5 5" name="Forecast" />
            <Line type="monotone" dataKey="optimistic" stroke="#22c55e" strokeDasharray="2 2" dot={false} name="Optimistic" strokeOpacity={0.4} />
            <Line type="monotone" dataKey="conservative" stroke="#eab308" strokeDasharray="2 2" dot={false} name="Conservative" strokeOpacity={0.4} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          ...
          <ResponsiveContainer width="100%" height={200}>
            <LineChart data={forecast.rpmTrend}>
              ...
              <Line type="monotone" dataKey="rpm" stroke="#a855f7" dot={false} name="RPM" />
            </LineChart>
          </ResponsiveContainer>
        </div>
      )}
