  ...
  return useQuery({
    ...
    queryFn: async (): Promise<Company[]> => {
      ...
      const { data, error } = await supabase
        .from("companies")
        .select("id, name, logo_url, industry, website, description, size, revenue, location, country, state, city, phone, primary_email, secondary_email, vip_tier, social_twitter, social_linkedin, social_youtube, social_instagram, social_facebook, social_tiktok, social_producthunt, social_whatsapp, notes, response_sla_minutes, last_contact_date, created_at, updated_at, contacts(id, first_name, last_name, email, role, status)")
