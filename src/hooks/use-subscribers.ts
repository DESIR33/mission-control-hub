  ...
  return useQuery({
    ...
    queryFn: async (): Promise<Subscriber[]> => {
      ...
      const { data, error } = await supabase
        ...
        .select("id, workspace_id, email, first_name, last_name, status, source, source_video_id, source_video_title, guide_requested, guide_delivered_at, avatar_url, city, state, country, notes, engagement_score, engagement_data, opt_in_confirmed, opt_in_confirmed_at, promoted_to_contact_id, custom_fields, page_url, referrer, beehiiv_id, beehiiv_status, beehiiv_tier, utm_source, utm_medium, utm_campaign, created_at, updated_at")
