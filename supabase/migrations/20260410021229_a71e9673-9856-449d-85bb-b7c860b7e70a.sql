CREATE OR REPLACE FUNCTION public.hybrid_memory_search(query_embedding text, query_text text, ws_id uuid, origin_filter text DEFAULT 'any'::text, match_count integer DEFAULT 5)
